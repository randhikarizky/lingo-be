...
export const DIFFICULTIES: DifficultyDefinition[] = [
  {
    ...
    label: "Beginner",
    grammarLevel:
      "Use simple present, past, and future tenses with short sentences.",
  ...
  },
  {
    ...
    label: "Intermediate",
    grammarLevel:
      "Use mixed tenses, comparatives, and common phrasal verbs naturally.",
    responseLength:
      "Keep replies to 2-4 sentences with one follow-up question.",
  ...
  },
  {
    ...
    label: "Advanced",
    grammarLevel:
      "Use complex clauses, conditionals, and nuanced grammar naturally.",
    responseLength:
      "Use richer responses (3-5 sentences) with subtle feedback.",
